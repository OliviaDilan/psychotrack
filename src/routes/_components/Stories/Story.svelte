...
<li class="story-item">
  <Voter score={story.score} on:upvote={upvote} />
  <div class="main">
    <div class="details">
      ...
      {#if !inList && isStoryOwner}
        <div class="story-actions">
          <a class="story-action-button" href={`story/${story._id}/edit`}>
            edit
          </a>
          <span class="story-action-button" on:click={deleteStory}>delete</span>
        </div>
      {/if}
    </div>
    <div class="byline">
