...
<ul class="sort-options">
  <li class="sort-option active" class:active={sort === 'recent'}>
    <a href={`/page/${currentPage}?sort=recent`}>Recent</a>
  </li>
  <li class="sort-option" class:active={sort === 'top'}>
    <a href={`/page/${currentPage}?sort=top`}>Top</a>
  </li>
</ul>
